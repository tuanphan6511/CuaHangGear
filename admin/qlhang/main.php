...
<table class="table table-hover">
    ...
    ?>
            <form method="post">
                <tr>
                    <td width="80%"><input class="alert alert-primary" role="alert" name="txtten" type="text" class="form-control" value="<?php echo $d["tenhang"] ?>" required></td>
                    <td>
                    ...
                    <!---------kết hỏi -->
                    <td><a href="" data-toggle="modal" data-target="#exampleModal2"><i class="far fa-trash-alt"></i></a></td>
                </tr>
            </form>
        <?php
        } else {
        ?>
            <tr>
                <td width="80%"><?php echo $d["tenhang"] ?></td>
                <td><a href="index.php?action=sua&id=<?php echo $d["id"]; ?>"><i class="far fa-edit"></i></a></td>
                <td><?php $kiemtra=$mh->kiemtrahangtrongmathang($d["id"]); if($kiemtra==0){?><a data-toggle="modal" data-target="#exampleModal<?php echo $d["id"]; ?>" href=""><i class="far fa-trash-alt"></i></a><?php } ?></td>
